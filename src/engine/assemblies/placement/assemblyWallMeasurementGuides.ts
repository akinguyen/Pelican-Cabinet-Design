...
export function buildAssemblyWallMeasurementGuides(args: {
  ...
  ].filter(isAssemblyWallMeasurementGuide);
}
...
}): AssemblyWallMeasurementGuide | null {
  return findNearestMeasurementGuide({
    ...
    createGuide: (wallFace) => {
      ...
      return createHorizontalGuide({
        id: `assembly-wall-measurement:left:${wallFace.id}`,
...
function findNearestRightMeasurementGuide(args: {
  ...
  return findNearestMeasurementGuide({
    ...
    createGuide: (wallFace) => {
      ...
      return createHorizontalGuide({
        id: `assembly-wall-measurement:right:${wallFace.id}`,
  ...
  return findNearestMeasurementGuide({
    ...
    createGuide: (wallFace) => {
      ...
      return createVerticalGuide({
        id: `assembly-wall-measurement:bottom:${wallFace.id}`,
...
function findNearestTopMeasurementGuide(args: {
  ...
  return findNearestMeasurementGuide({
    ...
    createGuide: (wallFace) => {
      ...
      return createVerticalGuide({
        id: `assembly-wall-measurement:top:${wallFace.id}`,
...
function findNearestMeasurementGuide(args: {
  ...
  createGuide: (wallFace: AxisAlignedWallFace) => AssemblyWallMeasurementGuide | null;
}): AssemblyWallMeasurementGuide | null {
...
function isAssemblyWallMeasurementGuide(
  measurementGuide: AssemblyWallMeasurementGuide | null,
): measurementGuide is AssemblyWallMeasurementGuide {
