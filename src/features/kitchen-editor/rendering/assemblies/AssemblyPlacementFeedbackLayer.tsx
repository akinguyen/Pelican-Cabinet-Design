...
import { AssemblyWallAttachmentHighlights } from "./AssemblyWallAttachmentHighlights";
  ...
  return (
    <group>
      ...
      {sceneViewMode === "floor-plan" ? (
        <>
          <AssemblyWallAttachmentHighlights highlights={placementFeedback.wallAttachmentHighlights} />
