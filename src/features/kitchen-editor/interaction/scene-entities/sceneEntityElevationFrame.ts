...
export function createSceneEntityElevationFrame(args: { planeOriginInches?: Point3DInches; placedWallGraphs: readonly PlacedWallGraph[]; activeWallElevationTarget: WallElevationTarget | null }): SceneEntityElevationFrame | undefined {
